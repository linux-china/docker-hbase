...
RUN wget --quiet -O - http://apache.mirrors.tds.net/hbase/hbase-0.98.10.1/hbase-0.98.10.1-hadoop2-bin.tar.gz | tar --directory /usr/local -xzf -
RUN ln -s /usr/local/hbase-0.98.10.1-hadoop2 /usr/local/hbase
