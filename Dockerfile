...
RUN wget --quiet -O - http://www.eu.apache.org/dist/hbase/0.98.16.1/hbase-0.98.16.1-hadoop2-bin.tar.gz | tar --directory /usr/local -xzf -
RUN ln -s /usr/local/hbase-0.98.16.1-hadoop2 /usr/local/hbase
